...
public class AddGroupPostsActivity extends AppCompatActivity {
    ...
    //user info
    String name, email, uid, dp,groupCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("pakaya", "meka thama uba ewapu group eka: " + groupCategory);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddGroupPostsActivity.this, "Enter Title...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(AddGroupPostsActivity.this, "Enter description...", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (image_rui == null){
                    //post without image
                    uploadData(title, description, "noImage", postToGroup);
                } else {
                    //post with image
                    uploadData(title, description, String.valueOf(image_rui), postToGroup);
                }
            }
        });
    }

    private void uploadData(String title, String description, String uri, boolean postToGroup) {
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                hashMap.put("pGroup", "Group");
                                hashMap.put("pLike", "");
                                hashMap.put("pComment", "");
                                hashMap.put("pShare", "");
                                hashMap.put("gCategory", groupCategory);
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddGroupPostsActivity.this, "Post published", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                pd.dismiss();
                                                Toast.makeText(AddGroupPostsActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
