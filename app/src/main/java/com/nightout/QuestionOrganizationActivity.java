...
public class QuestionOrganizationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_organization);
        ...
        ArrayAdapter<CharSequence> locationAdapter = ArrayAdapter.createFromResource(QuestionOrganizationActivity.this,
        ...
        ArrayAdapter<CharSequence> AgeAdapter = ArrayAdapter.createFromResource(QuestionOrganizationActivity.this,
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Debug", "Question1RadioGroup checked ID: " + Question1RadioGroup.getCheckedRadioButtonId());
                Log.d("Debug", "Question3RadioGroup checked ID: " + Question3RadioGroup.getCheckedRadioButtonId());
    ...
    private void storeAnswersInDatabase(String answer1, String answer2, String answer3, String answer4, String answer5, String answer6, String answer7) {
        ...
        reference.child("OrganizationQuestions").child("answer1").setValue(answer1);
        reference.child("OrganizationQuestions").child("answer2").setValue(answer2);
        reference.child("OrganizationQuestions").child("answer3").setValue(answer3);
        reference.child("OrganizationQuestions").child("answer4").setValue(answer4);
        reference.child("OrganizationQuestions").child("answer5").setValue(answer5);
        reference.child("OrganizationQuestions").child("answer6").setValue(answer6);
        reference.child("OrganizationQuestions").child("answer7").setValue(answer7);
    ...
    private void redirectBasedOnUserType() {
        ...
        if ("Organization".equals(userType)) {
            startActivity(new Intent(QuestionOrganizationActivity.this, OrganizationDashboardActivity.class));
        } else if ("Individual".equals(userType)) {
            startActivity(new Intent(QuestionOrganizationActivity.this, DashboardActivity.class));
        }
